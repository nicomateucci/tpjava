...
<head>
<meta charset="UTF-8">
<title>Pagina de solicitud de datos de pago</title>
...
-->
	<div class="checkout">
		...
		<form class="form" autocomplete="off" novalidate method=post
			action="../../ServletVentaPasaje">
			<fieldset>
				<%Usuario user = (Usuario) request.getSession().getAttribute("usuarioLogeado");
    		if(user == null){%>

				<div class="form-group input-cart-number">
					<label for="dniPasajero">Dni del pasajero: </label> <input
						type="text" name="dniPasajero" class="form-control" />
				</div>
				<%} else { %>
				<div class="form-group input-cart-number">
					<label for="dniPasajero">Dni usuario: </label> <input type="text"
						name="dniPasajero" class="form-control" disabled
						value="<%= user.getDni()%>" />
				</div>
				<%} %>


				<label for="card-number">Numero</label> <input type="text"
					id="card-number" class="input-cart-number" maxlength="4" /> <input
					type="text" id="card-number-1" class="input-cart-number"
					maxlength="4" /> <input type="text" id="card-number-2"
					class="input-cart-number" maxlength="4" /> <input type="text"
					id="card-number-3" class="input-cart-number" maxlength="4" />
			</fieldset>
			<fieldset>
				<label for="card-holder">Nombre del titular</label> <input
			...
			<div class="form-group col-lg-9">
				<button type="submit" value="Ingresar" class="btn btn-info">Confirmar
					pago</button>
			</div>
		</form>
	</div>

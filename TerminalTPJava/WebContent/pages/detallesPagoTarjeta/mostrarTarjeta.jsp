	...
	<form class="form" autocomplete="off" novalidate method=post
		...
		<fieldset>
			...
			<div class="form-group input-cart-number">
				<label for="dniPasajero">Dni del pasajero: </label> <input type="text"
					name="dniPasajero" class="form-control" />
			</div>
			<%} else { %>
			<div class="form-group input-cart-number">
				<label for="dniPasajero">Dni usuario: </label> <input type="text"
					name="dniPasajero" class="form-control" disabled value="<%= user.getDni()%>"/>
			</div>
		<%} %>
		...
		<button class="btn">
			<i class="fa fa-lock"></i> Confirmar pago seguro
		</button>
	</form>
</div>
